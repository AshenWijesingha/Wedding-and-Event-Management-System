    ...
    <footer class="relative isolate mt-auto overflow-hidden bg-[#1a1512] text-[#cdbfae]">
        ...
        <div class="relative mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div class="ft-rise grid grid-cols-2 gap-x-8 gap-y-12 py-16 lg:grid-cols-4" style="animation-delay:.15s">
                ...
                <div>
                    ...
                    <ul class="mt-5 space-y-3.5 text-sm text-[#a99e8f]">
                        ...
                        @if(($branding['contact']['address'] ?? null))
                            <li class="leading-relaxed">{{ $branding['contact']['address'] }}</li>
                        @endif
                    </ul>
                </div>
                ...
                <!-- Hours / accent column -->
                <div>
                    <h3 class="text-[0.7rem] font-semibold uppercase tracking-[0.25em] text-[#c8a96a]">Visit</h3>
                    <ul class="mt-5 space-y-3.5 text-sm text-[#a99e8f]">
                        <li class="flex justify-between gap-4"><span>Mon&ndash;Fri</span><span class="text-[#cdbfae]">9&ndash;6</span></li>
                        <li class="flex justify-between gap-4"><span>Saturday</span><span class="text-[#cdbfae]">10&ndash;4</span></li>
                        <li class="flex justify-between gap-4"><span>Sunday</span><span class="text-[#cdbfae]">By appt.</span></li>
                    </ul>
                </div>
            </div>
