    ...
    <AppLayout title="Add Staff Member">
        <div class="max-w-xl mx-auto space-y-4">
            <div class="flex items-center gap-3">
                ...
                <h2 class="text-xl font-semibold text-gray-900">Add Staff Member</h2>
            </div>

            <form @submit.prevent="form.post('/admin/staff')" class="bg-white rounded-lg shadow-sm p-6 space-y-4">
