    ...
    <AppLayout title="Bookings">
        <div class="space-y-4">
            <div class="flex items-center justify-between">
                ...
                <Link href="/admin/bookings/create" class="inline-flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium px-4 py-2 rounded-lg">
