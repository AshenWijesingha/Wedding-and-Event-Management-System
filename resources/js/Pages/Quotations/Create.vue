            ...
            <form @submit.prevent="submit" class="space-y-4">
                ...
                <div class="bg-surface rounded-lg shadow-sm p-6 space-y-3">
                    <div class="flex items-center justify-between">
                        ...
                        <button type="button" @click="addItem" class="text-sm text-primary hover:text-primary-dark font-medium">+ Add item</button>
                    </div>
                    ...
                    <div class="border-t border-border pt-3 flex justify-end">
                        <div class="w-full max-w-xs space-y-2 text-sm">
                            ...
                            <div class="flex justify-between items-center gap-2">
                                <span class="text-ink-subtle">Discount ($)</span>
