...
const navigation = [
    ...
    { name: 'Hotels',        href: '/admin/hotels',            icon: 'M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6H15m-1.5 3H15m-1.5 3H15M9 21v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V21', permission: 'hotels.view' },
    ...
    { name: 'Approvals',     href: '/admin/approvals',         icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z', superAdminOnly: true },
